...
The training data consisted of embeddings generated from the [`krishnakamath/movielens-32m-movies-enriched`](https://huggingface.co/datasets/krishnakamath/movielens-32m-movies-enriched) dataset.

## Final Dataset with Semantic IDs

The Semantic IDs generated by this model have been applied to the entire MovieLens-32M enriched dataset. The final, comprehensive dataset, which includes the original metadata, the continuous embeddings, and the generated Semantic IDs, is available on the Hugging Face Hub at:

*   **Dataset:** [`krishnakamath/movielens-32m-movies-enriched-with-SIDs`](https://huggingface.co/datasets/krishnakamath/movielens-32m-movies-enriched-with-SIDs)

This dataset is the recommended resource for anyone looking to use the SIDs for downstream tasks.
